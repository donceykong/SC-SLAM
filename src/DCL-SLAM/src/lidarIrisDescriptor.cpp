	...
	const int cur_ptr)
{
	...
	if(min_distance < distance_threshold_)
	{
		...
		LOG(INFO) << "[Iris Intra Loop<" << id_ << ">] btn "
			<< cur_ptr << " and " << min_index << ". Dis: " << min_distance;
	}
	else
	{
		LOG(INFO) << "[Iris Intra Not loop<" << id_ << ">] btn "
			<< cur_ptr << " and " << min_index << ". Dis: " << min_distance;
	}
	return result;
}
	...
	const int cur_ptr)
{
	...
	if(min_distance < distance_threshold_)
	{
		result.first = min_index;
		result.second = min_bias;
		LOG(INFO) << "[Iris Inter Loop<" << id_ << ">] btn "
			<< iris_feature_index_pairs[cur_ptr].first << "-" << iris_feature_index_pairs[cur_ptr].second
			<< " and " << iris_feature_index_pairs[min_index].first << "-" << iris_feature_index_pairs[min_index].second
			<< ". Dis: " << min_distance << ". Bias:" << min_bias;
	}
	else
	{
		LOG(INFO) << "[Iris Inter Not loop<" << id_ << ">] btn "
			<< iris_feature_index_pairs[cur_ptr].first << "-" << iris_feature_index_pairs[cur_ptr].second
			<< " and " << iris_feature_index_pairs[min_index].first << "-" << iris_feature_index_pairs[min_index].second
			<< ". Dis: " << min_distance << ". Bias:" << min_bias;
	}
