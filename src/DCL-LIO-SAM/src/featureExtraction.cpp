...
public:
    ...
    FeatureExtraction() : ParamServer("feature_extraction_node")
    {
        subLaserCloudInfo = create_subscription<dcl_lio_sam::msg::CloudInfo>(
            "lio_sam/deskew/cloud_info", qos_reliable(5),
            std::bind(&FeatureExtraction::laserCloudInfoHandler, this, std::placeholders::_1));

        pubLaserCloudInfo = create_publisher<dcl_lio_sam::msg::CloudInfo>("lio_sam/feature/cloud_info", qos_reliable(5));
        pubCornerPoints   = create_publisher<sensor_msgs::msg::PointCloud2>("lio_sam/feature/cloud_corner", qos_reliable(1));
        pubSurfacePoints  = create_publisher<sensor_msgs::msg::PointCloud2>("lio_sam/feature/cloud_surface", qos_reliable(1));
